...
public class EntryUserController {
  ...
  @Transactional(rollbackFor = Exception.class)
  public RestResponse selectUser(){
    RestResponse restResponse = new RestResponse(200, "ok");
    List<EntryUser> entryUsers = functionService.UserList();
    restResponse.setContent(entryUsers);
    return restResponse;
   }
}
